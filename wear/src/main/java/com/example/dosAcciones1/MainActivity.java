...
import com.example.dosAcciones1.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wBoton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Hace el intent de ir a otro Activity
                ...
                String name = "Hay 1 notificación";
                ...
                notification = new NotificationCompat.Builder(MainActivity.this, idChannel)
                        ...
                        .setContentText("Notificación con acciones")
